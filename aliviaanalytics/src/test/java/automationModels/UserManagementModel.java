...
public class UserManagementModel extends Configuration {
	...
	public void LandingOnAdminViewPage() {
		...
		utilityMethods.visible(this.MenuButton,
				"GetStarted:Verify that Profile Button is present.");
		utilityMethods.clickable(this.MenuButton,
				"Get Started:Verify that Profile Button is clickable.");
		...
		actions.moveToElement(this.AdminView).build().perform();
	...
	public void UserDetailFormValidation() {
		...
		// User 
		utilityMethods.visible(this.Users, 
				"Admin View:Verify that Users Button is present.");
		utilityMethods.clickable(this.Users,
				"Admin View:Verify that Users Button clickable.");
		...
		utilityMethods.sendKeys_Input(this.userNameEmailID_Input, 500, "includeChar",
				...
				// ... Email Validation .... //
		utilityMethods.verifyValidationFields("Invalid_Info",this.userNameEmailID_Input,userName, this.userNameEmailID_Error, 
		...
		utilityMethods.verifyValidationFields("Invalid_Info",this.userNameEmailID_Input,userName+"@gmail", this.userNameEmailID_Error, 
				"Admin View:Verify that error appear on the field when enter invalid Email 3 { "+userName+"@gmail }.");
		utilityMethods.verifyValidationFields("Invalid_Info",this.userNameEmailID_Input,userName+"@gmail.c", this.userNameEmailID_Error, 
				"Admin View:Verify that error appear on the field when enter invalid Email 3 { "+userName+"@gmail.c }.");
		utilityMethods.verifyValidationFields("Valid_Info",this.userNameEmailID_Input,userName+"@gmail.com", this.userNameEmailID_Error, 
				"Admin View:Verify that No error appear on the field when enter valid Email { "+userName+"@gmail.com }.");
		...
		utilityMethods.clickable(this.title_Input,
		...
		utilityMethods.verifyValidationFields("Invalid_Info",this.firstName_Input,userName+"!@", this.firstName_Error, 
		...
		utilityMethods.clickable(this.password_input,
		...
		utilityMethods.sendKeys_Input(this.password_input, 500, "includeChar",
				...
				// ... Password Validation ... //
		utilityMethods.verifyValidationFields("Valid_Info",this.password_input,userName+"123@", this.password_Error, 
		...
		// Confirm Password
		utilityMethods.visible(this.cpassword_Div, 
				"Admin View:Verify that Confirm Password field is present.");
		utilityMethods.clickable(this.cpassword_input,
				"Admin View:Verify that Confirm Password field is clickable.");
		...
		utilityMethods.verifyValidationFields("Valid_Info",this.cpassword_input,userName+"123@", this.cpassword_Error, 
		...
		utilityMethods.verifyDropdownManadatory(this.prefferedLanguage_Dropdown, 500, this.userNameEmailID_Input, this.prefferedLanguage_Error_Div, 
		...
		utilityMethods.verifyDropdownManadatory(this.userGroup_Dropdown, 500, this.userNameEmailID_Input, this.userGroup_Error_Div, 
		...
		utilityMethods.visible(this.UserLocked, 
				"Admin View:Verify that User Locked checkbox is present.");
		utilityMethods.clickable(this.UserLocked, 
				"Admin View:Verify that User Locked checkbox is clickable.");
